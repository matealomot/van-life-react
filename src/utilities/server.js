    ...
    routes() {
        ...
        this.post("/login", (schema, request) => {
            ...
            if (!foundUser) {
                ...
                // You need to add the Response class from MiragjeJS for it to properly render the error code responses we set up
            }
